...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        //프래그먼트 뷰로 보여주기
        gridView = (GridView) inflater.inflate(R.layout.fragment_gallery, container, false);
    ...
    private void updateGridViewWithData(List<DTO> dtoList) {
        gridAdapter.setDTOList(dtoList);
        gridAdapter.notifyDataSetChanged();
    }

    //그리드뷰 어댑터 dtoList 기반으로 뷰 형성
    private class GridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textView.setText(dtoList.get(position).getPhotoPath());
